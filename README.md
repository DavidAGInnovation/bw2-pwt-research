...
See [`data/generic-and-rental-records.md`](data/generic-and-rental-records.md) for the complete source-record masks, generic record groups, derived priority/category/trainer-type fields, and the proved Rental/Mix candidate pools.
